...
| `batch.rs` | main-line only; INV-2 blunders; concurrency cap | **`white_blunder_is_measured_from_whites_perspective`**, `a_plan_ignores_variations`, `in_flight_scales_with_threads_and_saturates_at_sixteen` |
